<template>
  <!-- ========== HEADER ========== -->
  <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-2 sm:py-0">
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
      <div class="flex items-center justify-between">
        <a class="flex-none text-xl font-semibold" href="#" aria-label="Brand">ATMS</a>
        <div class="sm:hidden">
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end py-2 md:py-0 sm:ps-7">
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#" aria-current="page">Data</a>
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#">Automations</a>
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#">Interfaces</a>
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#">Users</a>
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#">Artists</a>
          <a class="py-3 ps-px sm:px-3 font-medium text-gray-500 hover:text-gray-400" href="#">Events</a>
          ...
          <a class="flex items-center gap-x-2 font-semibold text-gray-500 hover:text-blue-600 sm:border-s sm:border-gray-300 py-2 sm:py-0 sm:my-6 sm:ps-6" href="#">
  ...
  <nav class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    <div class="relative flex flex-row justify-between items-center gap-x-8 border-t py-4 sm:py-0">
      <div class="flex items-center sm:w-[auto] w-full">
        <span class="font-semibold whitespace-nowrap text-gray-800 border-e border-e-white/70 sm:border-transparent pe-4 me-4 sm:py-3.5">My project</span>
      ...
      <div id="secondary-nav-toggle" class="hs-collapse hidden overflow-hidden transition-all duration-300 absolute top-16 end-0 w-full rounded-lg bg-white sm:block sm:static sm:top-0 sm:w-full sm:max-h-full sm:bg-transparent sm:overflow-visible">
        <div class="flex flex-col py-2 sm:flex-row sm:justify-end sm:gap-y-0 sm:gap-x-6 sm:py-0">
          <a class="text-sm font-semibold text-blue-600 py-2 sm:py-3.5" href="#">Overview</a>
          <a class="text-sm font-medium text-gray-800 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5" href="#">Features</a>
          <a class="text-sm font-medium text-gray-800 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5" href="#">Platforms</a>
          <a class="text-sm font-medium text-gray-800 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5" href="#">Pricing</a>
        </div>
      </div>
    </div>
  </nav>
